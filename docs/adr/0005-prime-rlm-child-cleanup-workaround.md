...
unexpected aggregate child, and any mismatch between the post-cleanup terminal event and the final
aggregate transcript are also rejected. Existing prompt admission, child relationship/name,
